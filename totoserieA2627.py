...
if excel_file is not None:
    ...
    if sezione_scelta == "🥇 Classifica Generale":
        ...
        if df_generale is not None and not df_generale.empty:
            st.dataframe(df_generale, hide_index=True, use_container_width=True, height=3000)
        else:
    ...
    # ---------------------------------------------
        ...
        with tab1:
            ...
            if df_trim1 is not None and not df_trim1.empty:
                st.dataframe(df_trim1, hide_index=True, use_container_width=True, height=3000)
            else:
        ...
        with tab2:
            ...
            if df_trim2 is not None and not df_trim2.empty:
                st.dataframe(df_trim2, hide_index=True, use_container_width=True, height=3000)
            else:
                st.info("Dati non disponibili")
        ...
        with tab3:
            ...
            if df_trim3 is not None and not df_trim3.empty:
                st.dataframe(df_trim3, hide_index=True, use_container_width=True, height=3000)
            else:
                st.info("Dati non disponibili")
    ...
    # ---------------------------------------------
        ...
        if df_giornata is not None and not df_giornata.empty:
            st.dataframe(df_giornata, hide_index=True, use_container_width=True, height=3000)
        else:
            classifica_base = []
    ...
    # ---------------------------------------------
        ...
        with tab_esatti:
            ...
            if df_esatti is not None and not df_esatti.empty:
                st.dataframe(df_esatti, hide_index=True, use_container_width=True, height=3000)
            else:
        ...
        with tab_segni:
            ...
            if df_segni is not None and not df_segni.empty:
                st.dataframe(df_segni, hide_index=True, use_container_width=True, height=3000)
            else:
